...
`site: Nick Brock` – change this to your website's name

`url: https://www.nickbrock.me` – the full URL that your site will be hosted at, e.g. https://your-domain.com
...
`logo_width` – set the width (in pixels) that your logo should appear at. This is useful for adding retina display support – for example if your original image is 400px wide, you could set this value to `200` to display a retina-ready image.
`footer_tagline` – sets the text that displays underneath the site title/logo in the footer.
